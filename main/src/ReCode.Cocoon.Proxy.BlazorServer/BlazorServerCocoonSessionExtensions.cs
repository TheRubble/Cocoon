...
namespace ReCode.Cocoon.Proxy.BlazorServer
{
    public static class BlazorServerCocoonSessionExtensions
    {
        public static IServiceCollection AddBlazorServerCocoonSession(this IServiceCollection services)
        {
